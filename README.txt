+ Пояснительные записки ко всем файлам: 
  ...
  * MAP.PY - https://docs.google.com/document/d/1DUX5PXV6rZQb29EfcpAItV_rzcYzHpQx6-dhlc2UMFQ/edit

  * MALEN.PY - https://docs.google.com/document/d/1Wvoudz_9FP9ikgGhRrNIb0oTtoiiSD06srtKrO90YCg/edit

  * PARAMETERS.PY - https://docs.google.com/document/d/1JSc-326haiN7OGNSBH_JraMrggSC2hXZPtkOQshnAAY/edit
...
+ Персонажи:
    ...
    * Солдат - рандомный чел с пушкой, мгновенно стреляет. ХП: 1, дальний бой.
...
+ Пушки:
    * Дробовик - медленное, но мощное оружие, наносит 3 единицы урона.
...
+ Также в игре присутсвуют аптечки, который восстанавливают 30 ХП ( изначально у игрока 100 ХП )
